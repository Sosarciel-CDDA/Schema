...
export type HasMission = TalkerVar<{
    /**有某个任务 */
    has_mission: IDExpr<MissionDefinitionID>;
},"has_mission">;
...
export type AtOmLocation = TalkerVar<{
     ...
     * 要检查的overmap位置ID  
     */
    at_om_location: (IDExpr<OvermapTerrainID>);
}, 'at_om_location'>;
...
export type HasAnyTrait = TalkerVar<{
     ...
     * 要检查的特性/突变ID列表  
     */
    has_any_trait: (IDExpr<MutationID>)[];
}, 'has_any_trait'>;
...
export type HasVisibleTrait = TalkerVar<{
     ...
     * 要检查的可见特性/突变ID  
     */
    has_visible_trait: (IDExpr<MutationID>);
}, 'has_visible_trait'>;
...
export type IsTraitPurifiable = TalkerVar<{
     ...
     * 要检查的特性ID  
     */
    is_trait_purifiable: (IDExpr<MutationID>);
}, 'is_trait_purifiable'>;
...
export type HasMartialArt = TalkerVar<{
     ...
     * 要检查的武术ID  
     */
    has_martial_art: (IDExpr<MartialArtID>);
}, 'has_martial_art'>;
...
export type UsingMartialArt = TalkerVar<{
     ...
     * 要检查的武术ID  
     */
    using_martial_art: (IDExpr<MartialArtID>);
}, 'using_martial_art'>;
...
export type CompareStringMatchAll = {
     ...
     */
    compare_string_match_all: (StringExpr)[];
}
...
export type HasPartTemp = TalkerVar<{
     ...
     * 要检查的温度值  
     */
    has_part_temp: (NumberExpr);
    /**身体部位  
     * 要检查的身体部位  
     */
    bodypart: (IDExpr<BodyPartID>);
}, 'has_part_temp'>;
...
export type HasItemCategory = TalkerVar<{
     ...
     * 要检查的物品类别  
     */
    has_item_category: (IDExpr<ItemCategoryID>);
    /**数量  
     * 需要的物品数量  
     */
    count?: (NumberExpr);
...
export type HasBionics = TalkerVar<{
     ...
     * 要检查的仿生学ID  
     */
    has_bionics: (IDExpr<BionicID|"ANY">);
}, 'has_bionics'>;
...
export type HasAnyEffect = TalkerVar<{
     ...
     * 要检查的效果ID列表  
     */
    has_any_effect: (IDExpr<EffectID>)[];
    /**身体部位  
     * 要检查的身体部位  
     */
    bodypart?: (IDExpr<BodyPartID>);
...
export type HasProficiency = TalkerVar<{
     ...
     * 要检查的专长ID  
     */
    has_proficiency: (IDExpr<ProficiencyID>);
}, 'has_proficiency'>;
...
export type HasWornWithFlag = TalkerVar<{
     ...
     * 要检查的标志ID  
     */
    has_worn_with_flag: (IDExpr<FlagID>);
}, 'has_worn_with_flag'>;
...
export type HasWieldedWithFlag = TalkerVar<{
     ...
     * 要检查的标志ID  
     */
    has_wielded_with_flag: (IDExpr<FlagID>);
...
export type HasWieldedWithWeaponCategory = TalkerVar<{
     ...
     * 要检查的武器类别  
     */
    has_wielded_with_weapon_category: (IDExpr<WeaponCategoryID>);
...
export type HasWieldedWithSkill = TalkerVar<{
     ...
     * 要检查的技能ID  
     */
    has_wielded_with_skill: IDExpr<SkillID>;
...
export type HasWieldedWithAmmotype = TalkerVar<{
     ...
     * 要检查的弹药类型  
     */
    has_wielded_with_ammotype: IDExpr<AmmunitionTypeID>;
...
export type IsOnTerrain = TalkerVar<{
     ...
     * 要检查的地形ID  
     */
    is_on_terrain: (IDExpr<TerrainID>);
}, 'is_on_terrain'>;
...
export type IsOnTerrainWithFlag = TalkerVar<{
     ...
     * 要检查的地形标志  
     */
    is_on_terrain_with_flag: (IDExpr<FlagID>);
...
export type IsInField = TalkerVar<{
     ...
     * 要检查的场地ID  
     */
    is_in_field: (IDExpr<FieldTypeID>);
}, 'is_in_field'>;
...
export type MapTerrainWithFlag = {
     ...
     * 要检查的地形标志  
     */
    map_terrain_with_flag: (IDExpr<FlagID>);
    /**位置  
     * 要检查的位置  
     */
    loc: (LocExpr);
...
export type MapFurnitureWithFlag = {
     ...
     * 要检查的家具标志  
     */
    map_furniture_with_flag: (IDExpr<FlagID>);
    /**位置  
     * 要检查的位置  
     */
    loc: (LocExpr);
...
export type MapTerrainId = {
     ...
     * 要检查的地形ID  
     */
    map_terrain_id: (IDExpr<TerrainID>);
    /**位置  
     * 要检查的位置  
     */
    loc: (LocExpr);
...
export type MapFurnitureId = {
     ...
     * 要检查的家具ID  
     */
    map_furniture_id: (IDExpr<FurnitureID>);
    /**位置  
     * 要检查的位置  
     */
    loc: (LocExpr);
...
export type MapFieldId = {
     ...
     * 要检查的场地ID  
     */
    map_field_id: (IDExpr<FieldTypeID>);
    /**位置  
     * 要检查的位置  
     */
    loc: (LocExpr);
