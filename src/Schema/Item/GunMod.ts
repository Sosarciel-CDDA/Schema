...
import { Energy, CddaID, Length, Time, DescText, Int, Float } from "../GenericDefine";
...
export type GunModTrait = ItemTrait<"GUNMOD",({
	...
	damage_modifier?: Int;
	/**增加或减少基础枪弹散的字段 */
	dispersion_modifier?: Int;
	/**增加或减少基础枪噪音的字段 */
	loudness_modifier?: Int;
	/**(可选) 增加或减少基础枪范围的字段 */
	range_modifier?: Int;
	/**(可选) 乘以基础枪范围的字段 */
