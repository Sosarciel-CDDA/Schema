...
export const ExtractDefineMindOverMatterPhotokinesisSpellIDList = [
    ...
    "photokinetic_sterilize_food" , // [Ψ]伽马灭菌 Use a focused emission of high-power radiation to eliminating microorganisms in food and allowing it to last much longer before rotting.  This power is <color_red>extremely taxing</color>.
    "photokinetic_stun_robots"    , // [Ψ]传感器干扰 Unleash a localized burst of electromagnetic radiation, overloading any electronic sensory equipment in the area.
    ...
    "photokinetic_light_flash"    , // [Ψ]恒星耀光 Create a destructive flash of light in a line, damaging all targets caught in the beam.
    "photokinetic_blinding_glare" , // [Ψ]Blinding Radiance (C) You can emit so much light that anyone trying to attack you risks being blinded.This power <color_yellow>is maintained by concentration</color> and <color_red>may fail</color> if <color_yellow>concentration is interrupted</color>.
    "photokinetic_light_disintegrate", // [Ψ]瓦解光束 将大量光线集中到一个单一目标上，将其瓦解。
    "photokinetic_light_army"     , // [Ψ]Phantom Legion (C) Create a myriad of illusions around yourself to mislead and confuse your enemies.  The illusions will explode into blinding flashes if damaged.This power <color_yellow>is maintained by concentration</color> and <color_red>may fail</color> if <color_yellow>concentration is interrupted</color>.  It requires <color_yellow>even more concentration</color> than usual.  Concentration will <color_green>automatically end</color> if all illusions are destroyed.
