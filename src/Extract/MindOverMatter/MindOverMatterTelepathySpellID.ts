...
export const ExtractDefineMindOverMatterTelepathySpellIDList = [
    ...
    "telepathic_mesmerize"        , // [Ψ]迷惑术 催眠一个目标，使其陷入恍惚状态，或是在一小片区域内徘徊。任何伤害都会使其从恍惚中惊醒。部分目标对迷惑术的抗性更强。
    ...
    "telepathic_network"          , // [Ψ]网络效应 在你和附近的盟友之间构筑一个潜意识的心灵网络，让你们能够收发关于周遭危险的情报，从而在战斗中更快地作出反应。此网络至少需要一名盟友在附近才能生效。
] as const;
