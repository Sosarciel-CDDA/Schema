...
export const ExtractDefineMagiclysmKelvinistSpellIDList = [
    "point_flare"                 , // 定点炎爆  在目标位置产生强热，对一切不耐高温的物质造成伤害。
    "nova_flare"                  , // 超新星炎爆 在目标位置产生炽热，对一切不耐高温的物质造成严重伤害。
    "create_lighter"              , // 火焰之指 召唤一小簇不会伤及自身的火焰，可用于引燃他物。此术似乎需要你心存点火之念方能生效，毕竟你都能若无其事地将这火焰揣入兜中。
    "ice_spike"                   , // 冰刺 在目标上方的空中凝结出嶙峋的冰锥，随即坠落伤敌。
    "fireball"                    , // 火球术 你投出一枚豌豆大小的荧光法球，它在击中障碍或抵达目标时会释放出一股无压的灼热爆风。
    ...
    "glide_ice_plus"              , // 强化冰上滑行<br> 为你的双足覆上一层魔法冰壳，使你在光滑表面上滑行得更快。如今你对此法术已了如指掌，并开始着手设计属于你自己的版本。
    "hoary_blast"                 , // 白霜冲击 你发射出一颗发光的白色冰晶，在撞击之处绽放酷寒。
    "ice_shield"                  , // 冰盾 在你的手臂上制造一个魔法冰盾，你可以用它在近战中保护自己，并使用它来攻击。
    "ice_shield_plus"             , // 强化冰盾 在你的手臂上制造一个魔法冰盾，你可以用它在近战中保护自己，并使用它来攻击。如今你对此法术已了如指掌，并开始着手设计属于你自己的版本。
    "frost_armor"                 , // 霜甲 用一层薄薄的魔法冰来保护你，反击你的敌人。
    "frost_armor_plus"            , // 强化霜甲 为你的身体覆上一层反应性魔法冰甲，用以反击伤你之人。如今你对此法术已了如指掌，并开始着手设计属于你自己的版本。
    "armor_frost_counterattack"   , // Frost Armor Counterattack Attacks anyone who hits you when using frost armor
    "create_rune_kelvinist"       , // 符文（炽霜法师） 该仪式通过冻结一小簇火焰，创造一枚与“开氏门徒”同调的符文。此符文可用作配方的催化剂。
    "kelvinist_summon_flamesword" , // 火焰剑 这个法术点燃一柄木剑，将其变成一把燃烧的剑。可以对敌人造成烧伤、钝击、斩击伤害。
    "kelvinist_summon_flamesword_plus", // 强化火焰剑 这个法术点燃一柄木剑，将其变成一把燃烧的剑。可以对敌人造成烧伤、钝击、斩击伤害。如今你对此法术已了如指掌，并开始着手设计属于你自己的版本。
    ...
    "kelvinist_summon_freezer_spell", // 寒冰结界 召唤一个寒冰法球，只要法球存续，置于其中的任何物品都将得到保鲜。
    "kelvinist_no_emotion_spell"  , // 霜封之心 凭借冰之精华，冻结所有感情，使你变得惬意地麻木。在那个还重视着这个法术的政府还没崩溃的时候，一旦政府知道你了解这个，你必然会上好几个名单。
    "kelvinist_firebolt"          , // 火焰弹 一个简单的咒语，向目标位置掷出一道闪电。虽然不像一些更复杂的咒语那样具有破坏性，但它施放速度很快，会点燃目标上的任何易燃物。
