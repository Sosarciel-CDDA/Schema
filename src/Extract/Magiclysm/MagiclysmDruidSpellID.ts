...
export const ExtractDefineMagiclysmDruidSpellIDList = [
    ...
    "druid_naturebow1_plus"       , // 升级版自然之弓 这个咒语可以变出一把神奇的木质反曲弓，以及与之相配的箭筒和箭簇。如今你对此法术已了如指掌，并开始着手设计属于你自己的版本。
    ...
    "druid_tornskin"              , // 刺皮术 这个法术，从卷轴上覆盖的汁液和尖刺看来，似乎像是棘皮术，但现在那些荆棘效果变成撕裂皮肤造成流血。也许那些被污染的单词可能改变了法术的效果。
    "druid_feralform"             , // 狂野形态 这个法术释放出你内心暗藏的兽性，让你长出尖牙利爪，将你的敌人撕成碎片。
    "druid_feralform_plus"        , // 高级狂野形态 这个法术释放出你内心暗藏的兽性，让你长出尖牙利爪，将你的敌人撕成碎片。现在你对这个法术了如指掌，并设计出了你自己的版本。
    "summon_wolf_druid"           , // 召唤狼 向荒野呼唤，寻求狼群的援助。
    "druid_natures_commune"       , // 沟通自然 你专注于周围的大自然，与之交流，改善你的健康和情绪，并安抚附近的野生动物。此咒语只能在远离文明的户外施放。
    "druid_growth"                , // 成长之种 在仪式中献出你的部分生命来换取成长的象征。
    "cause_rot"                   , // 腐化术 来自德鲁伊黑暗教派的法术，用来强行重启生命循环。因为没有腐化，就无法生长。影响范围很大，且不分敌我；即便是机器也会生锈化为尘土，施法及起效速度都很慢。曾经完全失传在时间的流逝中，这个法术被认为只不过是神话传说，是童话故事的素材，虽然是黑暗童话。
    "druid_cause_rot_terrain"     , // Cause Rot Terrain Rot The ruin terrain effect of the Cause Rot spell.  It's a bug if you have it directly.
    "druid_healing"               , // 恢复 利用自然的力量慢慢治愈你的伤口。你必须在在<color_yellow>户外且远离文明的自然区</color>才能施展恢复。
    "druid_healing_herb"          , // 鲜花疗法 使用一些魔法草药来治疗自己。
    "druid_bandage_heal"          , // 植物药膏 这个法术将树皮和树叶的混合物变成一种强大的药膏，即使是严重的伤口也能止血。
    "druid_whisper_leaves"        , // 叶之低语 这个法术可以让你在树叶的沙沙声和树根的吱吱声中听到树木的智慧，洞察森林的布局。
    "druid_harvest_hunter"        , // 猎人收获 这个法术从森林碎屑中制造出一组看起来奇怪但功能强大的箭。
    "druid_summon_tanglevine"     , // 召唤藤蔓 该法术会使一根有生命的藤蔓从地面破土而出，试图抓住附近的目标并将其牢牢固定。
