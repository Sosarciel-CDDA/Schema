...
export const ExtractDefineMagiclysmAnimistSpellIDList = [
    ...
    "necrotic_gaze"               , // 死灵凝视 使用存于符文之中的血液力量，将死灵能量注入到你的凝视之中，对你的凝视目标照成伤害。
    "create_rune_animist"         , // 符文（泛灵师） 进行一场仪式，将自身的部分血液转化为泛灵师符文。你可以使用符文来召唤生物，或者作为催化剂用于制造其它物品。
    "dominate"                    , // 统御丧尸 强迫你所选择的不死生物服从你的命令，使其暂时成为盟友。
    "life_detonation"             , // 生命爆炸 将生命能量强行施加于不死生物盟友身上，使其以巨大的威力爆炸。
    "life_detonation_explosion"   , // Life Detonation Explosion Detonation for life detonation spell.
    "convert"                     , // 符文转化 杀死一个友方生物，将其生命能量转化为一个小巧的符文，之后就可以使用了。
    "soulrend"                    , // 裂魂术 猛烈地将灵魂从躯体中撕裂，并将由此产生的暗影束缚在你的意志之下。
    "disruption_bolt"             , // 干扰波束 向附近的目标施放出一道共振的精神能量波束。它会破坏物质和灵魂之间的自然联系，造成严重但绝不会致命的伤害。
    "wrathful_spirits"            , // 愤怒灵魂 赋予孤魂野鬼短暂的肉体，让他们在你的指挥下战斗。
    "spirit_walk"                 , // 灵魂漫步 短暂地进入冥界，与你所控制下的任何灵魂之一交换位置。
    "banishment_lesser"           , // 放逐术 把怪物放逐到鲜为人知的异界维度之中。如果怪物比你更强大，这个法术会消耗你的生命来弥补其中的差异。
