...
export const ExtractDefineMagiclysmMagusSpellIDList = [
    ...
    "focused_bolt"                , // 聚能光束 你将魔力凝聚为一束微观尺度的纯能量脉冲射线，具备极致的射程与精准度；若技艺纯熟，更能发挥出无与伦比的穿透力。此法术为一位恶名昭彰的刺客所创，曾终结诸多君王与贵族的性命。历经世代仅通过直系血脉单传，虽偶有传承者将其授予外人。
