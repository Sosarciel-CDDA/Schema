/**从文件提取的预定义的MagiclysmStormshaperSpellID 列表*/
export const ExtractDefineMagiclysmStormshaperSpellIDList = [
    ...
    "stormshaper_wall_of_fog"     , // 雾墙术 召唤出一堵厚厚的雾墙。虽然突然出现的气压会击倒任何被困在里面的敌人，但这个魔法无法造成其它伤害。
    "stormshaper_repelling_arc"   , // 电弧光环 你在你周围召唤出一道噼啪作响的电弧光环，能放出可怕的闪电电击近战攻击你的敌人。
    "stormshaper_repelling_arc_plus", // 强化电弧光环 你在你周围召唤出一道噼啪作响的电弧光环，能放出可怕的闪电电击近战攻击你的敌人。现在你对这个法术了如指掌，并设计出了你自己的版本。
    ...
    "storm_superconductor"        , // 超导 在你周围的区域产生毁灭性电荷的弧线，烘烤里面的一切。
    "shocking_dash"               , // 雷霆冲刺 让你的双腿充满能量，快速冲向目标。
    "shocking_teleport"           , // 闪电传送 短暂地变成闪电传送到选定的地点，忽略路径上的所有障碍。
    "toxtricity"                  , // 电毒 向受影响区域内的目标注入腐蚀性电能，削弱它们，并随着时间的推移造成巨大伤害。
    "electric_eye"                , // 电磁视觉 运用你的能力增强你的视觉，使你能看见周围同源能量的生物。这种增强的感知速度使你能察觉到更多即将到来的攻击，从而有机会尝试做出额外的格挡或闪避。
    "electric_waves"              , // 电波 你的双手开始蓄积庞大的能量，并在每次攻击时释放。你感觉到随着对该法术掌握程度的提高，其威力将会更强。
    "electric_arts"               , // 电荷艺术 一项专为初学风暴塑造者设计的法术，使他们能够减少自己新学到的经常不稳定能力可能对自己造成的伤害。
    "summon_teravolt"             , // 召唤特拉伏特 召唤一只特拉伏特，一只小型、半灵智的灵魂体，它会锁定敌对生物并在接近后爆炸成为一团巨大的电火花云。
    "stormshaper_cloak_of_fog"    , // 迷雾斗篷 向天空中的神灵求助，请他们帮你躲避敌人。 大雾会遮住你的通路，但你自己没有任何特殊能力看穿大雾。
